...
def _reconstruct_vertex_62(param, whitening=True, dense=False, transform=True, lmk_pts=68):
    """
    ...
    p, offset, alpha_shp, alpha_exp = _parse_param_62(param_)
...
class LmkLoss(keras.losses.Loss):
    ...
    def call(self, y_true_param, y_pred):
        ...
        y_true_lmk = _reconstruct_vertex_62(y_true_param)
        y_pred_lmk = y_pred
...
class LmkAcc(keras.metrics.Metric):
    ...
    def update_state(self, y_true_param, y_pred_lmk, sample_weight=None):
        ...
        true_lmk = _reconstruct_vertex_62(y_true_param)
